...
BEGIN 
	...
	BEGIN
		...
		ALTER DATABASE TruckLoadMarket ADD FILE ( NAME = 'TruckLoadMarket_Archive', FILENAME = N'D:\Data\TruckLoadMarket_Archive.NDF', SIZE = 1GB, MAXSIZE = UNLIMITED, FILEGROWTH = 1GB )
		TO FILEGROUP TruckLoadMarket_Archive;
